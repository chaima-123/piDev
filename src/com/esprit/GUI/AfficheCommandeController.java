...
switch (comboFilter.getValue())
       {
           case "Commande annulée":
               tableCommande.getSelectionModel().clearSelection();
                   ObservableList<CommandeFournisseur> ob = FXCollections.observableArrayList(s.afficherCommandeAnnulee());
...
cellNum.setCellValueFactory(new PropertyValueFactory<>("num_commande"));
        ...
        tableCommande.setItems(ob);
               break;

        
    case "Commande en cours":
               tableCommande.getSelectionModel().clearSelection();
                   ObservableList<CommandeFournisseur> ob1 = FXCollections.observableArrayList(s.afficherCommandeEnCours());
...
cellNum.setCellValueFactory(new PropertyValueFactory<>("num_commande"));
        ...
        tableCommande.setItems(ob1);
               break;
               
    case "Commande arrivée":
               tableCommande.getSelectionModel().clearSelection();
                   ObservableList<CommandeFournisseur> ob2 = FXCollections.observableArrayList(s.afficherCommandeLivree());
...
cellNum.setCellValueFactory(new PropertyValueFactory<>("num_commande"));
        ...
        tableCommande.setItems(ob2);
               break;
               case "Date commande":
               tableCommande.getSelectionModel().clearSelection();
                   ObservableList<CommandeFournisseur> ob3 = FXCollections.observableArrayList(s.afficherCommandeFitrerParDateCommande());
...
cellNum.setCellValueFactory(new PropertyValueFactory<>("num_commande"));
        ...
        tableCommande.setItems(ob3);
               break;
               case "Date livraison":
               tableCommande.getSelectionModel().clearSelection();
                   ObservableList<CommandeFournisseur> ob4 = FXCollections.observableArrayList(s.afficherCommandeFitrerParDateLivraison());
...
cellNum.setCellValueFactory(new PropertyValueFactory<>("num_commande"));
        ...
        tableCommande.setItems(ob4);
               break;
               case "Tout":
               tableCommande.getSelectionModel().clearSelection();
                   ObservableList<CommandeFournisseur> ob5 = FXCollections.observableArrayList(s.afficherCommande());
...
cellNum.setCellValueFactory(new PropertyValueFactory<>("num_commande"));
    ...
    public void afficherTableau() throws SQLException {
        ...
        for (int i = 0; i < lcf.size(); i++) {
            obliste.add(new CommandeFournisseur(s.afficherCommande().get(i).getNum_commande(), s.afficherCommande().get(i).getRef_article(),
                    s.afficherCommande().get(i).getQte(), s.afficherCommande().get(i).getNomSociete(), s.afficherCommande().get(i).getDate_commande(), s.afficherCommande().get(i).getMontant(), s.afficherCommande().get(i).getDate_livraison(), s.afficherCommande().get(i).getEtat()));
